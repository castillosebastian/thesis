...
Testeamos distintas métricas de pérdida, como L1 en lugar de MSE para evaluar si la L1_loss podría ofrecer mejoras.
...
En el conjunto de datos   Gisette  , se observa que el modelo entrenado con datos reales supera al modelo entrenado con datos sintéticos. El MLP con datos reales alcanza una exactitud del **97%**, mientras que el modelo con datos sintéticos logró una buena performance en la mayoría de las métricas evaluadas. 
