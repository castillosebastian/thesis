# Ecuación del Esquema en el contexto de los AGs {#sec-appB}

La Ecuación del Esquema [@goldbergdavide.GeneticAlgorithmsSearch1989] predice el número esperado de copias de un esquema $H$ en la próxima generación $t+1$, dado su número de copias en la generación actual $t$. Se expresa de la siguiente manera:
