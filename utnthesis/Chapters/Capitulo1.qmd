# Marco específico de trabajo {#sec-Capitulo1}
...
Para la etapa de experimentos hemos incluido un quinto dataset para validar resultados. Este nuevo conjunto posee las siguientes características:

5.  *All Leukemia*: Es un dataset empleado en el estudio de pacientes pediátricos con leucemia linfoblástica aguda (LLA). Incluye 327 muestras con información de 12600 variables (i.e.genes). Está commpuesto por 14 clases desequilibradas. Fue compilado por Yeoh, Eng-Juh y ot., en *Classification, subtype discovery, and prediction of outcome in pediatric acute lymphoblastic leukemia by gene expression profiling*, Cancer Cell, Volume 1, Issue 2, 133 - 143. [link](https://www.cell.com/cancer-cell/fulltext/S1535-6108(02)00032-6?_returnURL=https%3A%2F%2Flinkinghub.elsevier.com%2Fretrieve%2Fpii%2FS1535610802000326%3Fshowall%3Dtrue)
