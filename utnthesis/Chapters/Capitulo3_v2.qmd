...
La tabla anterior muestra el rendimiento de un MLP entrenado con datos reales frente a uno entrenado con datos sintéticos en el conjunto de datos Leukemia. Se observa que el modelo entrenado con datos sintéticos logra una mayor exactitud (**95%**) en comparación con el modelo entrenado con datos reales (**81%**). Las métricas de *precisión*, *recall* y *F1 Score* son superiores en casi todas las clases y promedios cuando se utiliza el modelo sobre datos sintéticos. 
